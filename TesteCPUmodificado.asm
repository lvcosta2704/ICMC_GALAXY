...
; INICIO DO TESTE DA INSTRUCAO IMPLEMENTADA PELO GRUPO (SWAP)
	loadn r1, #43981	; 43981 é em hexa OxABCD
	swap r2, r1 ; r2 swap(r1)
	loadn r3, #52651 ; carrega o r3 com o numero da resposta (0xCDAB)
	cmp r2, r3  ; compara r2 com r3
	jeq SwapPassou
SwapFalhou:
	halt

SwapPassou:
	; se chegou ate aqui no código quer dizer que o swap foi bem sucedido
	; imprime a letra "Q"
	loadn r0, #32
	loadn r1, #81
	outchar r1, r0
